 ...
 */
package com.example.thread.myapplication;
...
public class PlayerActivity extends AppCompatActivity implements OnClickListener, ExoPlayer.EventListener,
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    getIntent().putExtra(PlayerActivity.URI_LIST_EXTRA, new String[]{"https://storage.googleapis.com/exoplayer-test-media-1/gen-3/screens/dash-vod-single-segment/video-avc-baseline-480.mp4"})
            .putExtra(PlayerActivity.EXTENSION_LIST_EXTRA, new String[]{"mp4"})
...
//      trackSelectionHelper = null;
  ...
  public void onLoadingChanged(boolean isLoading) {
    // Do nothing.
    showToast(String.valueOf(isLoading));
  }
